...
- "If the quick start fails on your machine, please open an issue."
- "Public-data examples are welcome, especially with clear caveats."
- "Small docs PRs are useful and appreciated."
