...
The `cross-market-5` preset is intentionally small: `SPY`, `QQQ`, `TLT`, `GLD`,
and `AGG`. It covers US equity beta, growth/tech equity, long-duration
Treasuries, gold, and aggregate bonds while keeping provider load low.
