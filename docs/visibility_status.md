...
- Latest GitHub rolling 14-day traffic window available through 2026-09-14:
  1,218 views from 217 unique visitors, and 349 clones from 158 unique cloners.
- Top referrers by visits in the window: GitHub (119), Google (68),
  ChatGPT (33), Zhihu (6), Bing (2), arXiv (2), Hugging Face (2), and the
  project site (1). These are visits, not unique-user totals.
- High-interest paths beyond the repository root include Releases,
...
- Top referrers: GitHub, Google, Bing, Zhihu, JoinQuant, Doubao,
  ChatGPT, arXiv, the project site, and Baidu.
- High-interest paths beyond the repository root: `README.zh-CN.md`,
  `docs/factor_handbook.md`, the main tree view, releases, issue #22,
  issue #7, and contributor PRs.

Operating takeaways:

- Unique cloners continue to rise even while views normalize after the launch
  spike, which suggests deeper evaluation by a smaller but more committed
  audience.
...
> PyTorch research stack for ML multi-factor trading: 213 factors, bias correction,
> portfolio optimization, and vectorized backtesting.
