...
This repository is most likely to grow by becoming the easiest public reference for
machine-learning multi-factor research workflows: runnable demos, transparent assumptions,
benchmarks, and small extension points.

## Positioning

One sentence:

> An end-to-end PyTorch research stack for ML-enhanced multi-factor trading: factor tensors,
> bias correction, portfolio optimization, and reproducible backtests.
...
The aim is not viral noise. The aim is to make the repository easier to trust, easier to run,
