...
def cal(n, gamma, mu, GT, x0, w, dt, stock, pred, ret, trade_file):
    ...
    with mosek.Env() as env:
        with env.Task(0, 0) as task:
            ...
            task.putvarbound(offsets + 0, mosek.boundkey.ra, 0.01, gamma)
            ...
            a = np.array(GT).dot(np.array(tmp))
...
if __name__ == '__main__':
    #l = [[0.2778, 0.0387, 0.0021],[0.0387, 0.1112, -0.0020],[0.0021, -0.0020, 0.0115]]
    generate_trade_df()
