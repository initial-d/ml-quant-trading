...
def calc_feature(df, stock, cols):
    ...
    if(len(split_date) > 0):
        for i in range(len(split_date) + 1):
            ...
            fea.append(split_df['rank'].shift(1))
            fea.append(split_df['rank'].shift(2))
            fea.append(split_df['rank'].shift(3))
            fea.append(split_df['rank'].shift(4))
            fea.append(split_df['rank'].shift(5))
    ...
    #print(res_df)
        ...
        fea.append(df['rank'])
        fea.append(df['rank'].shift(1))
        fea.append(df['rank'].shift(2))
        fea.append(df['rank'].shift(3))
        fea.append(df['rank'].shift(4))
        fea.append(df['rank'].shift(5))
