...
model_saving_path = './lr0001_kl/model.pt'
forced_saving_path = './lr0001_kl/model_force.pt'
...
#dataset = StockData_mini_batch_tensor_for_train_gpu_gbm('./test/tensor_data_merge_gbm_19_20.pickle')

for epoch in np.arange(n_epochs):

    #dataset = StockData_mini_batch_tensor_for_train_gpu_gbm('./tensor_data_merge_19_20.pickle')
