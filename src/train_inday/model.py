...
class StockPred_v9(nn.Module):
    ...
    def forward(self, data):
        ...
        d4_out = self.layer_4(d3_out)
        d5_out = self.layer_5(d4_out)
        #print(self.layer_5.W.weight.tolist())
        #print(self.layer_5.W.bias.tolist())
        return d5_out
...
class StockPred_v10(nn.Module):
    def __init__(self):
        ...
        #self.layer_1 = LinearLayer(144, 128, torch.sigmoid)
        self.layer_1 = LinearLayer(570, 128, torch.sigmoid)
        self.layer_2 = LinearLayer(128, 64, torch.sigmoid)
        self.layer_3 = LinearLayer(64, 64, torch.sigmoid)
        self.layer_4 = LinearLayer(64, 32, torch.sigmoid)
        self.layer_5 = LinearLayer(32, 1, None)
...
class Feature_KLDivLoss(nn.Module):
    def __init__(self):
        super(Feature_KLDivLoss, self).__init__()
        self.layer_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_2 = LinearLayer(128, 64, torch.sigmoid)
        self.layer_3 = LinearLayer(64, 64, torch.sigmoid)
        self.layer_4 = LinearLayer(64, 64, torch.sigmoid)
