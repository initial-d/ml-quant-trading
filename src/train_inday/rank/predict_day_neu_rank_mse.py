...
model = StockPred_v13().to(device)
#model = StockPred_v11().to(device)
...
#_valid_data = StockData_mini_batch_day_inday_tensor('./tensor_data_test_torch_fea.pickle', device)
...
#_valid_data = StockData_day_neu_rank_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_test_rank.pickle', device)
#_valid_data = StockData_day_neu_rank_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_test_rank.pickle', device)
#_valid_data = StockData_day_neu_rank_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_newest_rank.pickle', device)

_valid_data = StockData_day_neu_rank_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_2022_rank.pickle', device)
#_valid_data = StockData_day_neu_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_test.pickle', device)
#_valid_data = StockData_day_neu_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_newest.pickle', device)
#_valid_data = StockData_mini_batch_mse('/da1/public/duyimin/data/tensor_data_neutralize_price_test.pickle', device)
#_valid_data = StockData_mini_batch_mse('/da1/public/duyimin/data/tensor_data_concat3_k15_test.pickle', device)
#_valid_data = StockData_mini_batch_tensor_gbm_pre('/da1/public/duyimin/data/tensor_data_concat3_k15_newest.pickle', device)
#_valid_data = StockData_mini_batch_tensor_gbm_pre('/da1/public/duyimin/data/tensor_data_concat3_newest.pickle', device)
...
t_test_data, l_test_data, date, stocks, today_close, test_rank = _valid_data.x, _valid_data.real_return, _valid_data.date, _valid_data.stocks, _valid_data.today_close, _valid_data.y
label_list = (l_test_data.numpy().reshape(-1)).tolist()
test_rank = (test_rank.numpy().reshape(-1)).tolist()
date_list = date
stocks_list = stocks
model.eval()
with torch.no_grad():
    ...
    pre = model.predict(t_test_data.to(device))
    #print(pre.detach().cpu().numpy().tolist())
    #pre = torch.exp(pre)
    ...
    for i in range(len(label_list)):
        fo.write(str(stocks[i]) + "\t" + str(date[i]) + "\t" + str(label_list[i]) + "\t" + str(pre_list[i]) + "\t" + str(today_close[i]) + "\t" + str(test_rank[i]) + '\n' )
