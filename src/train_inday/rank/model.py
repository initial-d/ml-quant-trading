...
class StockPred_v7(nn.Module):
    def __init__(self):
        ...
        self.layer_0_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_0_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_1_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_1_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_1_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_2_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_2_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_2_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_3_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_3_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_3_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_4_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_4_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_4_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_5_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_5_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_5_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_6_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_6_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_6_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_7_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_7_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_7_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_8_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_8_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_8_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_9_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_9_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_9_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_10_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_10_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_10_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_11_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_11_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_11_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_12_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_12_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_12_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_13_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_13_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_13_3 = LinearLayer(128, 64, torch.sigmoid)

        self.layer_14_1 = LinearLayer(189, 128, torch.sigmoid)
        self.layer_14_2 = LinearLayer(128, 128, torch.sigmoid)
        self.layer_14_3 = LinearLayer(128, 64, torch.sigmoid)


        self.layer_4 = LinearLayer(128, 64, torch.sigmoid)
    ...
    def forward(self, data1, data2, id):
        ...
        if id == 0:
            dd1_out = self.layer_0_1(data2)
            dd2_out = self.layer_0_2(dd1_out)
            dd3_out = self.layer_0_3(dd2_out)

            data = torch.cat([d3_out, dd3_out], dim=1)
            ...
            dd1_out = self.layer_1_1(data2)
            dd2_out = self.layer_1_2(dd1_out)
            dd3_out = self.layer_1_3(dd2_out)
            ...
            dd1_out = self.layer_2_1(data2)
            dd2_out = self.layer_2_2(dd1_out)
            dd3_out = self.layer_2_3(dd2_out)
            ...
            dd1_out = self.layer_3_1(data2)
            dd2_out = self.layer_3_2(dd1_out)
            dd3_out = self.layer_3_3(dd2_out)
            ...
            dd1_out = self.layer_4_1(data2)
            dd2_out = self.layer_4_2(dd1_out)
            dd3_out = self.layer_4_3(dd2_out)
            ...
            dd1_out = self.layer_5_1(data2)
            dd2_out = self.layer_5_2(dd1_out)
            dd3_out = self.layer_5_3(dd2_out)
            ...
            dd1_out = self.layer_6_1(data2)
            dd2_out = self.layer_6_2(dd1_out)
            dd3_out = self.layer_6_3(dd2_out)
            ...
            dd1_out = self.layer_7_1(data2)
            dd2_out = self.layer_7_2(dd1_out)
            dd3_out = self.layer_7_3(dd2_out)
            ...
            dd1_out = self.layer_8_1(data2)
            dd2_out = self.layer_8_2(dd1_out)
            dd3_out = self.layer_8_3(dd2_out)
            ...
            dd1_out = self.layer_9_1(data2)
            dd2_out = self.layer_9_2(dd1_out)
            dd3_out = self.layer_9_3(dd2_out)
            ...
            dd1_out = self.layer_10_1(data2)
            dd2_out = self.layer_10_2(dd1_out)
            dd3_out = self.layer_10_3(dd2_out)
            ...
            dd1_out = self.layer_11_1(data2)
            dd2_out = self.layer_11_2(dd1_out)
            dd3_out = self.layer_11_3(dd2_out)
            ...
            dd1_out = self.layer_12_1(data2)
            dd2_out = self.layer_12_2(dd1_out)
            dd3_out = self.layer_12_3(dd2_out)
            ...
            dd1_out = self.layer_13_1(data2)
            dd2_out = self.layer_13_2(dd1_out)
            dd3_out = self.layer_13_3(dd2_out)
            ...
            dd1_out = self.layer_14_1(data2)
            dd2_out = self.layer_14_2(dd1_out)
            dd3_out = self.layer_14_3(dd2_out)
...
class Feature_200_KLDivLoss(nn.Module):
    def __init__(self):
        super(Feature_200_KLDivLoss, self).__init__()
        self.layer_1 = LinearLayer(380, 128, torch.sigmoid)
        #self.layer_1 = LinearLayer(190, 128, torch.sigmoid)
        self.layer_2 = LinearLayer(128, 64, torch.sigmoid)
        self.layer_3 = LinearLayer(64, 64, torch.sigmoid)
        self.layer_4 = LinearLayer(64, 64, torch.sigmoid)
        self.layer_5 = LinearLayer(64, 41, None)
...
class Feature_570_KLDivLoss(nn.Module):
    def __init__(self):
        super(Feature_570_KLDivLoss, self).__init__()
        self.layer_1 = LinearLayer(567, 128, torch.sigmoid)
        #self.layer_1 = LinearLayer(190, 128, torch.sigmoid)
        self.layer_2 = LinearLayer(128, 64, torch.sigmoid)
        self.layer_3 = LinearLayer(64, 64, torch.sigmoid)
        self.layer_4 = LinearLayer(64, 64, torch.sigmoid)
...
class StockPred_v8(nn.Module):
    def __init__(self):
        super(StockPred_v8, self).__init__()
        
        #self.layer_1 = LinearLayer(144, 128, torch.sigmoid)
        self.layer_1 = LinearLayer(149, 128, torch.sigmoid)
        self.layer_2 = LinearLayer(128, 64, torch.sigmoid)
        self.layer_3 = LinearLayer(64, 32, torch.sigmoid)
        self.layer_4 = LinearLayer(32, 16, torch.sigmoid)
        self.layer_5 = LinearLayer(16, 1, None)
...
class StockPred_v9(nn.Module):
    def __init__(self):
        super(StockPred_v9, self).__init__()
...
class StockPred_v10(nn.Module):
    def __init__(self):
        super(StockPred_v10, self).__init__()
...
class StockPred_v11(nn.Module):
    def __init__(self):
        super(StockPred_v11, self).__init__()
        
        #self.layer_1 = LinearLayer(144, 128, torch.sigmoid)
        self.layer_1 = LinearLayer(189, 128, F.relu)
        self.layer_2 = LinearLayer(128, 64, F.relu)
        self.layer_3 = LinearLayer(64, 32, F.relu)
        self.layer_4 = LinearLayer(32, 16, F.relu)
        self.layer_5 = LinearLayer(16, 1, None)
        #self.m1 = nn.Dropout(p=0.5)
        #self.m2 = nn.Dropout(p=0.3)
        #self.m3 = nn.Dropout(p=0.2)
        #self.m4 = nn.Dropout(p=0.1)
...
class StockPred_v12(nn.Module):
    def __init__(self):
        super(StockPred_v12, self).__init__()
        
        #self.layer_1 = LinearLayer(144, 128, torch.sigmoid)
        self.layer_1 = LinearLayer(567, 128, F.relu)
        self.layer_2 = LinearLayer(128, 64, F.relu)
        self.layer_3 = LinearLayer(64, 32, F.relu)
        self.layer_4 = LinearLayer(32, 16, F.relu)
        self.layer_5 = LinearLayer(16, 1, None)
...
class StockPred_v13(nn.Module):
    def __init__(self):
        super(StockPred_v13, self).__init__()
        
        #self.layer_1 = LinearLayer(144, 128, torch.sigmoid)
        self.layer_1 = LinearLayer(189, 64, F.relu)
        self.layer_2 = LinearLayer(64, 32, F.relu)
        self.layer_3 = LinearLayer(32, 16, F.relu)
        self.layer_4 = LinearLayer(16, 1, None)
        #self.m1 = nn.Dropout(p=0.5)
        #self.m2 = nn.Dropout(p=0.3)
        #self.m3 = nn.Dropout(p=0.2)
        #self.m4 = nn.Dropout(p=0.1)
