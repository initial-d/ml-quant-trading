...
class StockData_tensor_merge(data.Dataset):
...
if __name__ == '__main__' :
    ...
    dataset1 = StockData_tensor_merge('./tensor_data_minute_2019.pickle')
    dataset2 = StockData_tensor_merge('./tensor_data_minute_2020.pickle')
    dataset3 = StockData_tensor_merge('./tensor_data_minute_2021.pickle')
    tensor_data = {}
    tensor_data['x'] = torch.cat([dataset1.x, dataset2.x, dataset3.x], dim = 0) 
    tensor_data['y'] = torch.cat([dataset1.y, dataset2.y, dataset3.y], dim = 0)
    tensor_data['date'] = np.concatenate((dataset1.date, dataset2.date, dataset3.date), axis=0)
    tensor_data['stocks'] = np.concatenate((dataset1.stocks, dataset2.stocks, dataset3.stocks), axis=0)
    tensor_data['today_close'] = np.concatenate((dataset1.today_close, dataset2.today_close, dataset3.today_close), axis=0)
    tensor_data['halfday_close'] = np.concatenate((dataset1.halfday_close, dataset2.halfday_close, dataset3.halfday_close), axis=0)
    fp = open("tensor_data_merge_19_20_21.pickle", 'wb')
    pickle.dump(tensor_data, fp,  protocol=4)
    #fp = "tensor_data_merge_19_20_21.pickle"
    #joblib.dump(tensor_data, fp)
