...
model_saving_path = './lr0001_day_neu_rank_relu_shp_v13/model.pt'
forced_saving_path = './lr0001_day_neu_rank_relu_shp_v13/model_force.pt'
...
class AdjMSELoss0(nn.Module):
    def __init__(self):
        super(AdjMSELoss0, self).__init__()
                
    def forward(self, outputs, labels):
        outputs = torch.squeeze(outputs)
        alpha = 2
        #loss = (torch.mul((outputs - labels), labels))**2
        loss = (outputs - labels)**2
...
#dataset = StockData_mini_batch_mse('/da1/public/duyimin/data/tensor_data_neutralize_price.pickle')
#dataset = StockData_day_neu_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_train.pickle')
#dataset = StockData_day_neu_rank_mse('/da1/public/duyimin/data/tensor_data_neutralize_day_train_rank.pickle')
dataset = StockData_day_neu_rank_mse_shp('/da1/public/duyimin/data/tensor_data_neutralize_day_train_rank_adj_return.pickle')

for epoch in np.arange(n_epochs):
    #dataset = StockData_mini_batch_tensor_for_train_gpu_gbm('/da1/public/duyimin/data/tensor_data_concat3_train.pickle')
    #dataset = StockData_mini_batch_tensor_gbm('/da1/public/duyimin/data/tensor_data_concat3_train.pickle')
    ...
    for batch_num in range(total_batches):
        ...
        #loss = custom_mse(pre, l_data.float())
        loss = criterion(pre, l_data.float())
