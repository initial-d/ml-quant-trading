...
t_test_data, l_test_data, date, stocks, today_close = _valid_data.x, _valid_data.real_return, _valid_data.date, _valid_data.stocks, _valid_data.today_close
...
with torch.no_grad():
    ...
    for i in range(len(label_list)):
        fo.write(str(stocks[i]) + "\t" + str(date[i]) + "\t" + str(label_list[i]) + "\t" + str(pre_list[i]) + "\t" + str(today_close[i])  + '\n' )
